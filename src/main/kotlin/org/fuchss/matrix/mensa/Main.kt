...
private suspend fun handleTextMessage(event: Event<RoomMessageEventContent.TextMessageEventContent>, matrixBot: MatrixBot) {
    ...
    if (message.startsWith("!name")) {
        changeUsername(event, matrixBot, message)
    }

    if (message.startsWith("!mensa")) {
        printMensa(event, matrixBot)
    }
}
...
private suspend fun printMensa(event: Event<RoomMessageEventContent.TextMessageEventContent>, matrixBot: MatrixBot) {
